...
mkdir bundles
git submodule add git://github.com/solars/hobo-vim.git bundles/hobo-vim
git commit -m "added hobo-vim"
git submodule add git://github.com/scrooloose/nerdtree.git bundles/nerdtree
git commit -m "added nerdtree"
git submodule add git://github.com/scrooloose/nerdcommenter.git bundles/nerdcommenter
git commit -m "added nerdcommenter"
git submodule add git://github.com/msanders/snipmate.vim.git bundles/snipmate.vim
git commit -m "added snipmate.vim"
git submodule add git://github.com/tpope/vim-cucumber.git bundles/vim-cucumber
git commit -m "added vim-cucumber"
git submodule add git://github.com/tpope/vim-haml.git bundles/vim-haml
git commit -m "added vim-haml"
git submodule add git://github.com/astashov/vim-ruby-debugger.git bundles/vim-ruby-debugger
git commit -m "added vim-ruby-debugger"
git submodule add git://github.com/tpope/vim-fugitive.git bundles/vim-fugitive
git commit -m "added vim-fugitive"
git submodule add git://github.com/tpope/vim-surround.git bundles/vim-surround
git commit -m "added vim-surround"
git submodule add git://github.com/tpope/vim-repeat.git bundles/vim-repeat
git commit -m "added vim-repeat"
git submodule add git://github.com/jamis/fuzzyfinder_textmate.git bundles/fuzzyfinder_textmate
